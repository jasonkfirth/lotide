...
///
/// This is just an alias for `ActorAndObjectOptOriginAndTarget<RemoveType>` because ActivityPub
/// Remove commonly carries the collection it removes an object from as `target`.
