...
community_interaction_server_blocked = This community's server is blocking this instance, so posting, commenting, and voting there are disabled.
community_interaction_user_blocked = This community appears to block your account, so posting, commenting, and voting there are disabled.
